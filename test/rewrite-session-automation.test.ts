...
describe('rewrite session automation', () => {
  ...
  it('parses completed and pending families from the inventory doc', async () => {
    ...
    expect(mod.parsePendingFamilies(inventoryDoc)).toContain('filters / backdrop-filters')
    expect(mod.findNextPendingFamily(inventoryDoc)).toBe('filters / backdrop-filters')
