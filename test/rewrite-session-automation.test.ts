...
describe('rewrite session automation', () => {
  ...
  it('parses completed and pending families from the inventory doc', async () => {
    ...
    expect(mod.parsePendingFamilies(inventoryDoc)).toContain('table display / caption / collapse')
    expect(mod.findNextPendingFamily(inventoryDoc)).toBe('table display / caption / collapse')
