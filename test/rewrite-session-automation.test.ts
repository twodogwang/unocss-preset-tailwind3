...
describe('rewrite session automation', () => {
  ...
  it('parses completed and pending families from the inventory doc', async () => {
    ...
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('text-stroke')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('text-shadow')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('line-clamp')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('font-variant-numeric')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('size / width / height / min / max')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('aspect-ratio')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('display')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('overflow')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('position / inset leftovers / float / z / order / box-sizing')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('container')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('columns')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('table display / caption / collapse')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('flex')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('grid')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('justify / align / place / flexGridJustifiesAlignments')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('transform')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('filters / backdrop-filters')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('animation')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('appearance')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('will-change')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('overscroll')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('scroll-behavior')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('touch-action')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('list-style')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('image-rendering')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('cursor / pointer-events / resize / user-select')
    expect(mod.parseCompletedFamilies(inventoryDoc)).toContain('fill')
    expect(mod.parsePendingFamilies(inventoryDoc)).toContain('white-space / breaks / hyphens / content-visibility / contents / field-sizing / color-scheme')
    expect(mod.findNextPendingFamily(inventoryDoc)).toBe('white-space / breaks / hyphens / content-visibility / contents / field-sizing / color-scheme')
