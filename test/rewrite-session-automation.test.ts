...
describe('rewrite session automation', () => {
  ...
  it('parses completed and pending families from the inventory doc', async () => {
    ...
    expect(mod.parsePendingFamilies(inventoryDoc)).toContain('justify / align / place / flexGridJustifiesAlignments')
    expect(mod.findNextPendingFamily(inventoryDoc)).toBe('justify / align / place / flexGridJustifiesAlignments')
