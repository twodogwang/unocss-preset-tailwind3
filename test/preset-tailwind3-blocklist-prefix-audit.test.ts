...
const migrationFixtures: MigrationFixture[] = [
  ...
  {
    label: 'legacy inline flex alias',
    matcher: /^flex-inline$/,
    input: 'flex-inline',
    prefixed: 'tw-flex-inline',
    replacement: 'inline-flex',
  },
  {
    label: 'legacy basis alias',
    matcher: /^flex-basis-((?:\d+\.?\d*|\d*\.\d+)(?:%|px|r?em|ex|ch|vh|vw|vmin|vmax|svh|svw|lvh|lvw|dvh|dvw|cm|mm|in|pt|pc)|(?:var|calc|min|max|clamp)\(.+\))$/,
    input: 'flex-basis-10px',
    prefixed: 'tw-flex-basis-10px',
  ...
  },
  {
    ...
    matcher: /^auto-flow-(.+)$/,
    input: 'auto-flow-row',
    prefixed: 'tw-auto-flow-row',
    replacement: 'grid-flow-row',
  },
  {
    label: 'legacy grid rows alias',
    matcher: /^rows-(.+)$/,
    input: 'rows-2',
    prefixed: 'tw-rows-2',
    replacement: 'grid-rows-2',
  },
  {
    label: 'legacy grid cols alias',
    matcher: /^cols-(.+)$/,
    input: 'cols-2',
    prefixed: 'tw-cols-2',
  ...
  {
    label: 'legacy transform rotate alias',
    matcher: /^transform-rotate-(.+)$/,
    input: 'transform-rotate-45',
    prefixed: 'tw-transform-rotate-45',
    replacement: 'rotate-45',
  },
  {
    label: 'legacy transform origin alias',
    matcher: /^transform-origin-(.+)$/,
    input: 'transform-origin-top-right',
    prefixed: 'tw-transform-origin-top-right',
    replacement: 'origin-top-right',
  },
  {
    label: 'raw translate arbitrary alias',
    matcher: /^(-?translate-[xy]-)((?:(?:\d+\.?\d*|\d*\.\d+)(?:%|px|r?em|ex|ch|vh|vw|vmin|vmax|svh|svw|lvh|lvw|dvh|dvw|cm|mm|in|pt|pc)|(?:var|calc|min|max|clamp)\(.+\)))$/,
    input: 'translate-x-12px',
    prefixed: 'tw-translate-x-12px',
    replacement: 'translate-x-[12px]',
  },
  {
    label: 'legacy filter alias',
    matcher: /^filter-(blur|brightness|contrast|drop-shadow|grayscale|hue-rotate|invert|saturate|sepia)(?:-(.+))?$/,
    input: 'filter-blur-sm',
    prefixed: 'tw-filter-blur-sm',
    replacement: 'blur-sm',
  },
  {
    label: 'legacy filter alias variant',
    matcher: /^filter-(blur|brightness|contrast|drop-shadow|grayscale|hue-rotate|invert|saturate|sepia)(?:-(.+))?$/,
    input: 'filter-drop-shadow',
    prefixed: 'tw-filter-drop-shadow',
    replacement: 'drop-shadow',
  },
  {
    label: 'legacy backdrop opacity shorthand',
    matcher: /^backdrop-op-(.+)$/,
    input: 'backdrop-op-50',
    prefixed: 'tw-backdrop-op-50',
    replacement: 'backdrop-opacity-50',
  },
  {
