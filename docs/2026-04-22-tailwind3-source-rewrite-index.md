...
- 第二阶段已完成模板化：`background-color / bg-opacity`、`background-style / gradient / clip / origin / repeat / position`、`ring`、`decoration / underline-offset`、`shadow`、`divide`、`fill`、`accent`、`caret`、`font`、`text-align`、`vertical-align`、`text-decoration`、`text-indent`、`text-wrap / text-overflow / text-transform`、`tab-size`、`text-stroke`、`text-shadow`、`line-clamp`、`font-variant-numeric`、`size / width / height / min / max`、`aspect-ratio`、`display`、`overflow`、`position / inset leftovers / float / z / order / box-sizing`、`container`、`columns`、`table display / caption / collapse`、`flex`、`grid`、`justify / align / place / flexGridJustifiesAlignments`、`transform`、`filters / backdrop-filters`、`animation`、`appearance`、`will-change`、`overscroll`、`scroll-behavior`、`touch-action`、`list-style`、`image-rendering`、`cursor / pointer-events / resize / user-select`、`white-space / breaks / hyphens / content-visibility / contents / field-sizing / color-scheme`
...
- `flex` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-flex-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-flex-source-rewrite.md`
  - log: `docs/2026-04-26-flex-source-rewrite-log.md`
  - status: `docs/2026-04-26-flex-source-rewrite-status.md`
- `grid` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-grid-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-grid-source-rewrite.md`
  - log: `docs/2026-04-26-grid-source-rewrite-log.md`
  - status: `docs/2026-04-26-grid-source-rewrite-status.md`
- `justify / align / place / flexGridJustifiesAlignments` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-justify-align-place-source-rewrite-design.md`
...
- `filters / backdrop-filters` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-filters-backdrop-filters-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-filters-backdrop-filters-source-rewrite.md`
  - log: `docs/2026-04-26-filters-backdrop-filters-source-rewrite-log.md`
  - status: `docs/2026-04-26-filters-backdrop-filters-source-rewrite-status.md`
- `animation` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-animation-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-animation-source-rewrite.md`
  - log: `docs/2026-04-26-animation-source-rewrite-log.md`
  - status: `docs/2026-04-26-animation-source-rewrite-status.md`
- `appearance` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-appearance-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-appearance-source-rewrite.md`
  - log: `docs/2026-04-26-appearance-source-rewrite-log.md`
  - status: `docs/2026-04-26-appearance-source-rewrite-status.md`
- `will-change` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-will-change-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-will-change-source-rewrite.md`
  - log: `docs/2026-04-26-will-change-source-rewrite-log.md`
  - status: `docs/2026-04-26-will-change-source-rewrite-status.md`
- `overscroll` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-overscroll-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-overscroll-source-rewrite.md`
  - log: `docs/2026-04-26-overscroll-source-rewrite-log.md`
  - status: `docs/2026-04-26-overscroll-source-rewrite-status.md`
- `scroll-behavior` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-scroll-behavior-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-scroll-behavior-source-rewrite.md`
  - log: `docs/2026-04-26-scroll-behavior-source-rewrite-log.md`
  - status: `docs/2026-04-26-scroll-behavior-source-rewrite-status.md`
- `touch-action` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-touch-action-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-touch-action-source-rewrite.md`
  - log: `docs/2026-04-26-touch-action-source-rewrite-log.md`
  - status: `docs/2026-04-26-touch-action-source-rewrite-status.md`
- `list-style` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-list-style-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-list-style-source-rewrite.md`
  - log: `docs/2026-04-26-list-style-source-rewrite-log.md`
  - status: `docs/2026-04-26-list-style-source-rewrite-status.md`
- `image-rendering` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-image-rendering-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-image-rendering-source-rewrite.md`
  - log: `docs/2026-04-26-image-rendering-source-rewrite-log.md`
  - status: `docs/2026-04-26-image-rendering-source-rewrite-status.md`
- `cursor / pointer-events / resize / user-select` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-static-interaction-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-static-interaction-source-rewrite.md`
  - log: `docs/2026-04-26-static-interaction-source-rewrite-log.md`
  - status: `docs/2026-04-26-static-interaction-source-rewrite-status.md`
- `white-space / breaks / hyphens / content-visibility / contents / field-sizing / color-scheme` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-static-leftovers-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-static-leftovers-source-rewrite.md`
  - log: `docs/2026-04-26-static-leftovers-source-rewrite-log.md`
  - status: `docs/2026-04-26-static-leftovers-source-rewrite-status.md`
- `scroll-behavior` 已完成模板化：
  - spec: `docs/superpowers/specs/2026-04-26-scroll-behavior-source-rewrite-design.md`
  - plan: `docs/superpowers/plans/2026-04-26-scroll-behavior-source-rewrite.md`
  - log: `docs/2026-04-26-scroll-behavior-source-rewrite-log.md`
