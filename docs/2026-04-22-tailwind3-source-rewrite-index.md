...
- 第二阶段已完成模板化：`background-color / bg-opacity`、`background-style / gradient / clip / origin / repeat / position`、`ring`、`decoration / underline-offset`、`shadow`、`divide`、`fill`、`accent`、`caret`、`font`、`text-align`、`vertical-align`
