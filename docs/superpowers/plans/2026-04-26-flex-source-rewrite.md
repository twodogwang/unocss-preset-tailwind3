# Flex Source Rewrite Implementation Plan
...
- `test/fixtures/tailwind-flex-rewrite.ts`
...
- [x] Task 1: create shared fixture and dedicated runtime/parity tests for `flex`
- [x] Task 2: align `flex` runtime, theme typing, and default theme keys with Tailwind 3 official semantics
