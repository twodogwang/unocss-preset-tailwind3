...
function taggedAria(tagName: string, combinator: string, options: PresetTailwind3Options = {}): Variant {
  return {
    name: `${tagName}-aria`,
    match(matcher, ctx: VariantContext<Theme>) {
...
export function variantTaggedAriaAttributes(options: PresetTailwind3Options = {}): Variant[] {
  return [
