...
function taggedData(tagName: string, combinator: string, options: PresetTailwind3Options = {}): Variant {
  return {
    name: `${tagName}-data`,
    match(matcher, ctx: VariantContext<Theme>) {
...
export function variantTaggedDataAttributes(options: PresetTailwind3Options = {}): Variant[] {
  return [
