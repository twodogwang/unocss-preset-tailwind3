...
import { appearances, breaks, contains, contents, contentVisibility, cursors, displays, fieldSizing, fontSmoothings, fontStyles, hyphens, pointerEvents, resizes, textOverflows, textTransforms, textWraps, userSelects, whitespaces } from './static'
